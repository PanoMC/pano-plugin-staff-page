{#if addon?.id === 'pano-plugin-staff-page'}
  <div class="card">
    ...
    <div class="card-body">
      <!-- Display Location -->
      <div class="row mb-4">
        <label class="col-md-6 col-form-label" for="displayLocation1">
          <span class="d-block">
            {$_('settings.display-location')}
          </span>
          <small> {$_('settings.display-location-hint')} </small>
        </label>
        <div class="col-md-6">
          <div class="btn-group w-100" role="group">
            <input
              ...
              id="displayLocation1"
              value="THEME_PAGE"
              bind:group={config.displayLocation} />
            <label class="btn btn-outline-primary" for="displayLocation1"
              >{$_('settings.display-location-page')}</label>
            ...
            <input
              ...
              value="SUPPORT_PAGE"
              bind:group={config.displayLocation} />
            <label class="btn btn-outline-primary" for="displayLocation2"
              >{$_('settings.display-location-support')}</label>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-4" class:opacity-50={config.displayLocation !== 'THEME_PAGE'}>
        <label class="col-md-6 col-form-label" for="pageUrl">
          <span class="d-block">
            {$_('settings.page-url')}
          </span>
          <small>{$_('settings.page-url-hint')}</small>
        </label>
        <div class="col-md-6">
      ...
      <!-- View Mode -->
      <div class="row mb-4">
        <label class="col-md-6 col-form-label" for="viewMode1">
          <span class="d-block">
            {$_('settings.view-mode')}
          </span>
          <small> {$_('settings.view-mode-hint')} </small>
        </label>
        <div class="col-md-6">
          <div class="btn-group w-100" role="group">
            <input
